...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/graph/other/MaximumIndependentSet.md
    document_title: "MaximumIndependentSet(\u6700\u5927\u72EC\u7ACB\u96C6\u5408)"
    links: []
  bundledCode: "#line 2 \"graph/other/MaximumIndependentSet.hpp\"\n\n#line 2 \"other/template.hpp\"\
    ...
    \ */\n#line 5 \"graph/other/MaximumIndependentSet.hpp\"\n\ntemplate<unsigned int\
    \ SZ = 64> class MinimumVertexCover {\nprivate:\n    int n;\n    std::vector<std::bitset<SZ>>\
    \ G;\n    std::bitset<SZ> ans;\n    std::vector<int> res;\n    void dfs(std::bitset<SZ>\
    \ used, std::bitset<SZ> flag) {\n        if (used.count() >= ans.count()) return;\n\
    \        int v = -1, deg = -1;\n        rep (i, n)\n            if (flag[i]) {\n\
    \                auto tmp = flag & G[i];\n                int d = tmp.count();\n\
    \                if (d <= 1) {\n                    flag.reset(i);\n         \
    ...
    \    }\n    int size() const { return res.size(); }\n    const std::vector<int>&\
    \ get() const& { return res; }\n    std::vector<int> get() && { return std::move(res);\
    \ }\n};\n\n/**\n * @brief MaximumIndependentSet(\u6700\u5927\u72EC\u7ACB\u96C6\
  ...
  code: "#pragma once\n\n#include \"../../other/template.hpp\"\n#include \"../Graph.hpp\"\
    ...
    \            used.reset(v);\n            flag.set(v);\n        }\n        {\n\
    \            flag.reset(v);\n            dfs(used | tmp, flag ^ tmp);\n      \
    \      flag.set(v);\n        }\n    }\n\npublic:\n    template<class T> MinimumVertexCover(const\
    \ Graph<T>& G_) {\n        n = G_.size();\n        G.assign(n, std::bitset<SZ>());\n\
...
documentation_of: graph/other/MaximumIndependentSet.hpp
layout: document
redirect_from:
- /library/graph/other/MaximumIndependentSet.hpp
- /library/graph/other/MaximumIndependentSet.hpp.html
