...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/graph/other/ChromaticNumber.md
    document_title: "ChromaticNumber(\u5F69\u8272\u6570)"
    links: []
  bundledCode: "#line 2 \"graph/other/ChromaticNumber.hpp\"\n\n#line 2 \"other/template.hpp\"\
  ...
  requiredBy: []
  timestamp: '2023-07-17 18:50:02+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - test/yosupo/graph/chromatic_number.test.cpp
documentation_of: graph/other/ChromaticNumber.hpp
layout: document
redirect_from:
- /library/graph/other/ChromaticNumber.hpp
- /library/graph/other/ChromaticNumber.hpp.html
...
- `int chromatic_number(Graph<T> g)` : 彩色数を求める。 $\Theta(2^n n)$ 。
