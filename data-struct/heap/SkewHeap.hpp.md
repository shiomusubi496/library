...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/data-struct/heap/SkewHeap.md
    document_title: SkewHeap
    links: []
  bundledCode: "#line 2 \"data-struct/heap/SkewHeap.hpp\"\n\n#line 2 \"other/template.hpp\"\
    ...
    \ other) : root(copy(other.root)), sz(other.sz) {}\n    SkewHeap& operator=(const\
    \ SkewHeap& other) {\n        if (this != &other) {\n            clear();\n  \
    \          root = copy(other.root);\n            sz = other.sz;\n        }\n \
    \       return *this;\n    }\n    SkewHeap(SkewHeap&& other) noexcept : root(other.root),\
    \ sz(other.sz) {\n        other.root = nullptr;\n        other.sz = 0;\n    }\n\
...
documentation_of: data-struct/heap/SkewHeap.hpp
layout: document
redirect_from:
- /library/data-struct/heap/SkewHeap.hpp
- /library/data-struct/heap/SkewHeap.hpp.html
title: SkewHeap
---
## 概要
