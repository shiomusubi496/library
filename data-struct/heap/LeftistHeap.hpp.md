...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"data-struct/heap/LeftistHeap.hpp\"\n\n#line 2 \"other/template.hpp\"\
...
layout: document
redirect_from:
- /library/data-struct/heap/LeftistHeap.hpp
- /library/data-struct/heap/LeftistHeap.hpp.html
title: LeftistHeap
---
## 概要
...
また、全体に値を加算する操作も可能。もしくは、一つの値を変更する操作が償却 $\Theta(\log n)$ で行えるため Dijkstra のメモリ改善などにも使える。
