...
data:
  ...
  bundledCode: "#line 2 \"data-struct/other/PersistentQueue.hpp\"\n\n#line 2 \"other/template.hpp\"\
    ...
    \ push(int t, T val) {\n        assert(-1 <= t && t <= now());\n        root.push_back(new\
    \ node(val, root[t + 1]));\n        if (root[t + 1]) root.back()->sz = root[t\
    \ + 1]->sz + 1;\n        return now();\n    }\n    int clear(int t) {\n      \
    ...
    \ const { return (int)root.size() - 2; }\n\n    int size(int t) const {\n    \
    \    assert(-1 <= t && t <= now());\n        return root[t + 1][6] + stk.size(root[t\
  ...
  requiredBy: []
  timestamp: '2024-08-22 14:52:33+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - test/yosupo/data_structure/persistent_queue.test.cpp
documentation_of: data-struct/other/PersistentQueue.hpp
layout: document
redirect_from:
- /library/data-struct/other/PersistentQueue.hpp
- /library/data-struct/other/PersistentQueue.hpp.html
