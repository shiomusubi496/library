...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/data-struct/other/MaxRectangle.md
    document_title: "MaxRectangle(\u6700\u5927\u9577\u65B9\u5F62)"
    links: []
  bundledCode: "#line 2 \"data-struct/other/MaxRectangle.hpp\"\n\n#line 2 \"other/template.hpp\"\
    ...
    \n\ntemplate<class F>\nvoid max_rectangle_of_histogram(const std::vector<int>&\
    \ A, const F& f) {\n    const int N = A.size();\n    std::stack<int> st;\n   \
    ...
    \ (A[i][j]) B[i][j] = 0;\n    }\n    rep (i, H) {\n        max_rectangle_of_histogram(B[i],\
    \ [&](int l, int r, int h) {\n            f(i, l, i + h, r);\n        });\n  \
    \  }\n}\n\n/**\n * @brief MaxRectangle(\u6700\u5927\u9577\u65B9\u5F62)\n * @docs\
    \ docs/data-struct/other/MaxRectangle.md\n */\n"
  ...
  requiredBy: []
  timestamp: '2023-07-23 14:17:05+09:00'
...
layout: document
redirect_from:
- /library/data-struct/other/MaxRectangle.hpp
- /library/data-struct/other/MaxRectangle.hpp.html
