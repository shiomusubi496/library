...
data:
  ...
  code: "#pragma once\n\n#include \"../../other/template.hpp\"\n#include \"../../other/bitop.hpp\"\
    ...
    \ nullptr) val = M::op(val, r->val);\n        }\n        Node() : val(M::id()),\
    \ l(nullptr), r(nullptr) {}\n    };\n    ll ori, h, n;\n    Node_ptr root;\n \
    \   template<class Upd> void update(Node_ptr& nd, ll a, ll b, ll k, const Upd&\
    \ upd) {\n        if (a + 1 == b) {\n            nd->val = upd(nd->val);\n   \
    \         return;\n        }\n        ll m = (a + b) >> 1;\n        if (k < m)\
    \ update(nd->get_l(), a, m, k, upd);\n        else update(nd->get_r(), m, b, k,\
    \ upd);\n        nd->update();\n    }\n    T prod(const Node_ptr& nd, ll a, ll\
