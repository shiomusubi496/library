...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"data-struct/segment/StaticRangeCountDistinct.hpp\"\n\n#line\
  ...
  code: "#pragma once\n\n#include \"../../other/template.hpp\"\n#include \"BinaryIndexedTree.hpp\"\
    \n\ntemplate<class T>\nstd::vector<int>\nstatic_range_count_distinct(std::vector<T>\
    \ v,\n                            const std::vector<std::pair<int, int>>& qs)\
    \ {\n    int n = v.size();\n    compressor<T> ps(v, true);\n    ps.press(v);\n\
    \    int m = ps.size();\n    std::vector<int> lst(m, -1);\n    BinaryIndexedTree<int>\
    \ bit(n);\n    std::vector<int> res(qs.size());\n    std::vector<std::vector<std::pair<int,\
...
documentation_of: data-struct/segment/StaticRangeCountDistinct.hpp
layout: document
redirect_from:
- /library/data-struct/segment/StaticRangeCountDistinct.hpp
- /library/data-struct/segment/StaticRangeCountDistinct.hpp.html
