...
data:
  ...
  code: "#pragma once\n\n#include \"../../other/template.hpp\"\n#include \"../../other/bitop.hpp\"\
    ...
    \ node_ptr& nd, ll l, ll r, int t) const {\n        if (nd->l == nullptr) nd->l\
    \ = std::make_unique<node>(get_init(l, r, t));\n        return nd->l;\n    }\n\
    \    node_ptr& get_r(const node_ptr& nd, ll l, ll r, int t) const {\n        if\
    \ (nd->r == nullptr) nd->r = std::make_unique<node>(get_init(l, r, t));\n    \
    ...
    \ all_apply(get_r(nd, m, b, t - 1), t - 1, nd->lazy);\n            nd->lazyflag\
    \ = false;\n        }\n    }\n    ll ori, h, n;\n    std::vector<T> iv, iv2;\n\
    \    node_ptr root;\n    template<class Upd>\n    void update(node_ptr& nd, ll\
    \ a, ll b, int t, ll k, const Upd& upd) {\n        if (a + 1 == b) {\n       \
    \     nd->val = upd(nd->val);\n            return;\n        }\n        eval(nd,\
    \ a, b, t);\n        ll m = (a + b) >> 1;\n        if (k < m) update(get_l(nd,\
    \ a, m, t - 1), a, m, t - 1, k, upd);\n        else update(get_r(nd, m, b, t -\
    \ 1), m, b, t - 1, k, upd);\n        nd->val = M::op(nd->l ? nd->l->val : get_init(a,\
