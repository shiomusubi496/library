...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/staticrmq-LCARMQ.test.cpp\"\n#define PROBLEM\
    ...
    \ T, T max_value = infinity<T>::max> struct AssignMin {\n    using M = Min<T,\
    \ max_value>;\n    using E = Assign<T>;\n    static constexpr T op(T a, T) { return\
    \ a; }\n    static constexpr T mul(T a, int) { return a; }\n    static constexpr\
    \ T mul_op(T a, int, T) { return a; }\n};\n\ntemplate<class T, T min_value = infinity<T>::min>\
...
layout: document
redirect_from:
- /verify/test/yosupo/staticrmq-LCARMQ.test.cpp
- /verify/test/yosupo/staticrmq-LCARMQ.test.cpp.html
