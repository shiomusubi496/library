...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/polynomial/compositional_inverse_of_formal_power_series.test.cpp\"\
    ...
    \ 5 \"test/yosupo/polynomial/compositional_inverse_of_formal_power_series.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/compositional_inverse_of_formal_power_series\"\
    ...
    int main() {\n    int n; scan >> n;\n    FormalPowerSeries<mint> f(n); scan >>\
    \ f;\n    prints(f.compinv());\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
  ...
  verifiedWith: []
documentation_of: test/yosupo/polynomial/compositional_inverse_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/polynomial/compositional_inverse_of_formal_power_series.test.cpp
- /verify/test/yosupo/polynomial/compositional_inverse_of_formal_power_series.test.cpp.html
