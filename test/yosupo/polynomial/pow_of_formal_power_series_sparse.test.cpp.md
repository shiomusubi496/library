...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/polynomial/pow_of_formal_power_series_sparse.test.cpp\"\
    ...
    \ */\n#line 6 \"test/yosupo/polynomial/pow_of_formal_power_series_sparse.test.cpp\"\
    \nusing namespace std;\nusing mint = modint998244353;\nint main() {\n    int n,\
    \ k; scan >> n >> k;\n    ll m; scan >> m;\n    SparseFPS<mint> a(k); scan >>\
    \ a;\n    prints(a.pow(m, n));\n}\n"
...
layout: document
redirect_from:
- /verify/test/yosupo/polynomial/pow_of_formal_power_series_sparse.test.cpp
- /verify/test/yosupo/polynomial/pow_of_formal_power_series_sparse.test.cpp.html
