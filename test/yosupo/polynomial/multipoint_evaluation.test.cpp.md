...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/polynomial/multipoint_evaluation.test.cpp\"\n\
    ...
    \ 6 \"test/yosupo/polynomial/multipoint_evaluation.test.cpp\"\nusing namespace\
    \ std;\nusing mint = modint998244353;\nint main() {\n    int n, m; scan >> n >>\
    \ m;\n    FormalPowerSeries<mint> a(n); scan >> a;\n    vector<mint> b(m); scan\
...
layout: document
redirect_from:
- /verify/test/yosupo/polynomial/multipoint_evaluation.test.cpp
- /verify/test/yosupo/polynomial/multipoint_evaluation.test.cpp.html
