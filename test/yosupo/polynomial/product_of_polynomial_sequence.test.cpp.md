...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/polynomial/product_of_polynomial_sequence.test.cpp\"\
    ...
    \ */\n#line 5 \"test/yosupo/polynomial/product_of_polynomial_sequence.test.cpp\"\
    \nusing namespace std;\nusing mint = modint998244353;\nint main() {\n    int n;\
    \ scan >> n;\n    if (n == 0) {\n        prints(\"1\");\n        return 0;\n \
    \   }\n    queue<FormalPowerSeries<mint>> que;\n    rep (n) {\n        int d;\
    \ scan >> d;\n        FormalPowerSeries<mint> f(d + 1); scan >> f;\n        que.push(f);\n\
    \    }\n    while (que.size() != 1) {\n        FormalPowerSeries<mint> f = que.front();\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/product_of_polynomial_sequence\"\
    ...
    int main() {\n    int n; scan >> n;\n    if (n == 0) {\n        prints(\"1\");\n\
    \        return 0;\n    }\n    queue<FormalPowerSeries<mint>> que;\n    rep (n)\
    \ {\n        int d; scan >> d;\n        FormalPowerSeries<mint> f(d + 1); scan\
    \ >> f;\n        que.push(f);\n    }\n    while (que.size() != 1) {\n        FormalPowerSeries<mint>\
    \ f = que.front(); que.pop();\n        FormalPowerSeries<mint> g = que.front();\
    \ que.pop();\n        que.push(f * g);\n    }\n    prints(que.front());\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
