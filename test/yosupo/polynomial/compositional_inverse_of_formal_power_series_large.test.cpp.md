...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/polynomial/compositional_inverse_of_formal_power_series_large.test.cpp\"\
    ...
    \    std::reverse(all(g));\n    g.pop_back();\n    g = (g.log() / (1 - deg)).exp()\
    \ << 1;\n    T v = 1;\n    rep (i, deg) {\n        g[i] *= v;\n        v *= c;\n\
    \    }\n    return g;\n}\n#line 6 \"test/yosupo/polynomial/compositional_inverse_of_formal_power_series_large.test.cpp\"\
