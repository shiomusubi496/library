...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/graph/cycle_detection.test.cpp\"\n#define PROBLEM\
    ...
    \ << \"-1\" << endl;\n    else {\n        auto v = GC.get_cycle();\n        print\
    \ << v.size() << endl;\n        for (const auto& e : GC.get_cycle()) print <<\
    \ e.idx << endl;\n    }\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/cycle_detection\"\n#include\
    ...
    \    auto v = GC.get_cycle();\n        print << v.size() << endl;\n        for\
    \ (const auto& e : GC.get_cycle()) print << e.idx << endl;\n    }\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
  - template/alias.hpp
...
layout: document
redirect_from:
- /verify/test/yosupo/graph/cycle_detection.test.cpp
- /verify/test/yosupo/graph/cycle_detection.test.cpp.html
