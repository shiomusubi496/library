...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/graph/bipartite_edge_coloring.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/bipartite_edge_coloring\"\n#line 2\
    ...
    \ */\n#line 2 \"graph/other/BipartiteEdgeColoring.hpp\"\n\n#line 2 \"data-struct/unionfind/UnionFind.hpp\"\
    ...
    \       }\n        return res2;\n    }\n    void solve(int L, int R, Edges<T>\
    \ es) {\n        if (es.empty()) {\n            color_number = 0;\n          \
    ...
    \ L, int R, const Edges<T>& es) { solve(L, R, es); }\n    int edge_chromatic_number()\
    \ const { return color_number; }\n    const std::vector<int>& get() const& { return\
    ...
    \ rep (i, M) scan >> es[i].from >> es[i].to;\n    auto bec = BipartiteEdgeColoring<int>(L,\
  ...
  verifiedWith: []
documentation_of: test/yosupo/graph/bipartite_edge_coloring.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/graph/bipartite_edge_coloring.test.cpp
- /verify/test/yosupo/graph/bipartite_edge_coloring.test.cpp.html
