...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/graph/three_edge_connected_components.test.cpp\"\
    ...
    \ * @docs docs/graph/Graph.md\n */\n#line 2 \"graph/connected/ThreeEdgeConnectedComponents.hpp\"\
    \n\n#line 5 \"graph/connected/ThreeEdgeConnectedComponents.hpp\"\n\ntemplate<class\
    \ T> class ThreeEdgeConnectedComponents {\nprivate:\n    int n, cnt;\n    const\
    ...
    \           tes.push_back(e.idx);\n                if (ord[v] < low[e.to]) {\n\
    \                    is_cut[e.idx] = true;\n                    continue;\n  \
    \              }\n                if (!st[e.to].empty() && std::get<4>(st[e.to].top())\
    \ == e.to) {\n                    const auto [i, y, b, p, _] = st[e.to].top();\n\
    \                    st[e.to].pop();\n                    is_cut[i] = is_cut[e.idx]\
    \ = true;\n                    link[y] = v;\n                    if (p != v) st[e.to].emplace(i,\
    \ y, b, p, v);\n                }\n                if (low[e.to] < low[v]) {\n\
    \                    low2[v] = low[v];\n                    lowv2[v] = lowv[v];\n\
    \                    low[v] = low[e.to];\n                    lowv[v] = lowv[e.to];\n\
    ...
    \ */\n#line 5 \"test/yosupo/graph/three_edge_connected_components.test.cpp\"\n\
    using namespace std;\nint main() {\n    int n, m; cin >> n >> m;\n    Graph<int>\
    \ g(n);\n    rep (m) {\n        int a, b; cin >> a >> b;\n        g.add_edge(a,\
  ...
  verifiedWith: []
documentation_of: test/yosupo/graph/three_edge_connected_components.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/graph/three_edge_connected_components.test.cpp
- /verify/test/yosupo/graph/three_edge_connected_components.test.cpp.html
