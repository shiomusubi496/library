...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/linear_algebra/matrix_product.test.cpp\"\n#define\
    ...
    \ */\n#line 5 \"test/yosupo/linear_algebra/matrix_product.test.cpp\"\nusing namespace\
    \ std;\nusing mint = modint998244353;\nusing Mat = Matrix<mint>;\nint main() {\n\
    \    int N, M, K; scan >> N >> M >> K;\n    Mat A(N, M); scan >> A;\n    Mat B(M,\
    \ K); scan >> B;\n    Mat C = A * B;\n    for (const auto& v : C) printer << v\
    \ << endl;\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/matrix_product\"\n#include\
    ...
    using Mat = Matrix<mint>;\nint main() {\n    int N, M, K; scan >> N >> M >> K;\n\
    \    Mat A(N, M); scan >> A;\n    Mat B(M, K); scan >> B;\n    Mat C = A * B;\n\
    \    for (const auto& v : C) printer << v << endl;\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
  - template/alias.hpp
  ...
  verifiedWith: []
documentation_of: test/yosupo/linear_algebra/matrix_product.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/linear_algebra/matrix_product.test.cpp
- /verify/test/yosupo/linear_algebra/matrix_product.test.cpp.html
