...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/set_power_series/power_projection_of_set_power_series.test.cpp\"\
    ...
    \    }\n    return g;\n}\n#line 5 \"test/yosupo/set_power_series/power_projection_of_set_power_series.test.cpp\"\
    \nusing namespace std;\nusing mint = modint998244353;\nint main() {\n    int N,\
    \ M; scan >> N >> M;\n    std::vector<mint> a(1 << N), w(1 << N); scan >> a >>\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/power_projection_of_set_power_series\"\
    ...
    \ = modint998244353;\nint main() {\n    int N, M; scan >> N >> M;\n    std::vector<mint>\
    \ a(1 << N), w(1 << N); scan >> a >> w;\n    prints(power_projection_of_sps(a,\
    \ w, M));\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
  ...
  verifiedWith: []
documentation_of: test/yosupo/set_power_series/power_projection_of_set_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/set_power_series/power_projection_of_set_power_series.test.cpp
- /verify/test/yosupo/set_power_series/power_projection_of_set_power_series.test.cpp.html
