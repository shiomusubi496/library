...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/set_power_series/polynomial_composite_set_power_series.test.cpp\"\
    ...
    \ 1 << i) a[j + (1 << i)] = d[j];\n    }\n    return a;\n}\n#line 5 \"test/yosupo/set_power_series/polynomial_composite_set_power_series.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/polynomial_composite_set_power_series\"\
    ...
    \ a(M); scan >> a;\n    vector<mint> b(1 << N); scan >> b;\n    prints(polynomial_composite_of_sps(a,\
    \ b));\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
  ...
  verifiedWith: []
documentation_of: test/yosupo/set_power_series/polynomial_composite_set_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/set_power_series/polynomial_composite_set_power_series.test.cpp
- /verify/test/yosupo/set_power_series/polynomial_composite_set_power_series.test.cpp.html
