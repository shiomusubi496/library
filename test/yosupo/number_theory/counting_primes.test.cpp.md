...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/counting_primes.test.cpp\"\n#define\
    ...
    \ size() const {\n        assert(sorted);\n        return dat.size();\n    }\n\
    };\n#line 2 \"math/num/LucyDP.hpp\"\n\n#line 4 \"math/num/LucyDP.hpp\"\n\nll LucyDP(ll\
    \ n) {\n    ll m = 1;\n    while (m * m <= n) ++m;\n    --m;\n    ll m2 = n /\
...
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/counting_primes.test.cpp
- /verify/test/yosupo/number_theory/counting_primes.test.cpp.html
