...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/factorize.test.cpp\"\n#define\
    ...
    \ *= r[k].first;\n        }\n        self(k + 1, d);\n        d = t;\n    })(0,\
    \ 1);\n    std::sort(all(res));\n    return res;\n}\n\n/**\n * @brief PollardRho(\u7D20\
    \u56E0\u6570\u5206\u89E3)\n * @docs docs/math/PollardRho.md\n */\n#line 4 \"test/yosupo/number_theory/factorize.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int q; scan >> q;\n    rep (q) {\n \
  ...
  verifiedWith: []
documentation_of: test/yosupo/number_theory/factorize.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/factorize.test.cpp
- /verify/test/yosupo/number_theory/factorize.test.cpp.html
