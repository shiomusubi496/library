...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/gcd_of_gaussian_integers.test.cpp\"\
    ...
    \    GaussianInteger() : real(0), imag(0) {}\n    GaussianInteger(T real) : real(real),\
    ...
    \ operator+() { return *this; }\n    GaussianInteger operator-() const { return\
    ...
    \ imag * rhs.real;\n        real = tmp;\n        return *this;\n    }\n    friend\
    \ GaussianInteger operator+(const GaussianInteger& lhs,\n                    \
    ...
    \ */\n#line 4 \"test/yosupo/number_theory/gcd_of_gaussian_integers.test.cpp\"\n\
  ...
  verifiedWith: []
documentation_of: test/yosupo/number_theory/gcd_of_gaussian_integers.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/gcd_of_gaussian_integers.test.cpp
- /verify/test/yosupo/number_theory/gcd_of_gaussian_integers.test.cpp.html
