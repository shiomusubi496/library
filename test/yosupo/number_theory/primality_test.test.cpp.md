...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/primality_test.test.cpp\"\n#define\
    ...
    \u6570\u5224\u5B9A)\n * @docs docs/math/MillerRabin.md\n */\n#line 4 \"test/yosupo/number_theory/primality_test.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int T; scan >> T;\n    rep (T) {\n \
  ...
  verifiedWith: []
documentation_of: test/yosupo/number_theory/primality_test.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/primality_test.test.cpp
- /verify/test/yosupo/number_theory/primality_test.test.cpp.html
