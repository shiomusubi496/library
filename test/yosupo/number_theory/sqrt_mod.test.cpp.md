...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/sqrt_mod.test.cpp\"\n#define PROBLEM\
    ...
    \ * @see https://37zigen.com/tonelli-shanks-algorithm/\n */\n#line 4 \"test/yosupo/number_theory/sqrt_mod.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int t; scan >> t;\n    rep (t) {\n \
    \       ll y, p; scan >> y >> p;\n        prints(sqrt_mod(y, p));\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yosupo/number_theory/sqrt_mod.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/sqrt_mod.test.cpp
- /verify/test/yosupo/number_theory/sqrt_mod.test.cpp.html
