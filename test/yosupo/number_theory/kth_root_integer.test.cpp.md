...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/kth_root_integer.test.cpp\"\n\
    ...
    \ */\n#line 4 \"test/yosupo/number_theory/kth_root_integer.test.cpp\"\nusing namespace\
    \ std;\nint main() {\n    int T; scan >> T;\n    rep (T) {\n        ull a, k;\
    \ scan >> a >> k;\n        print << kth_root(a, k) << endl;\n    }\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/kth_root_integer\"\n#include\
    \ \"../../../other/template.hpp\"\n#include \"../../../math/num/KthRoot.hpp\"\n\
    using namespace std;\nint main() {\n    int T; scan >> T;\n    rep (T) {\n   \
    \     ull a, k; scan >> a >> k;\n        print << kth_root(a, k) << endl;\n  \
    \  }\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/yosupo/number_theory/kth_root_integer.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/kth_root_integer.test.cpp
- /verify/test/yosupo/number_theory/kth_root_integer.test.cpp.html
