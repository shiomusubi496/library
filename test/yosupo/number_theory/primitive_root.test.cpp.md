...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/primitive_root.test.cpp\"\n#define\
    ...
    \u6839)\n * @docs docs/math/PrimitiveRoot.md\n */\n#line 4 \"test/yosupo/number_theory/primitive_root.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int q; scan >> q;\n    rep (q) {\n \
  ...
  verifiedWith: []
documentation_of: test/yosupo/number_theory/primitive_root.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/primitive_root.test.cpp
- /verify/test/yosupo/number_theory/primitive_root.test.cpp.html
