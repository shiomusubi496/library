...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/number_theory/enumerate_quotients.test.cpp\"\
    ...
    \ size() const {\n        assert(sorted);\n        return dat.size();\n    }\n\
    };\n#line 2 \"math/num/EnumerateQuotients.hpp\"\n\n#line 4 \"math/num/EnumerateQuotients.hpp\"\
    \n\nstd::vector<ll> enumerate_quotients(ll n) {\n    std::vector<ll> res{1};\n\
    \    while (res.back() <= n) res.push_back(n / (n / res.back()) + 1);\n    return\
    \ res;\n}\n\n/**\n * @brief Enumerate Quotients(\u5546\u5217\u6319)\n * @docs\
    \ docs/math/num/EnumerateQuotients.md\n */\n#line 4 \"test/yosupo/number_theory/enumerate_quotients.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yosupo/number_theory/enumerate_quotients.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/number_theory/enumerate_quotients.test.cpp
- /verify/test/yosupo/number_theory/enumerate_quotients.test.cpp.html
