...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree/vertex_add_subtree_sum-HLD.test.cpp\"\n\
    ...
    \ */\n#line 6 \"test/yosupo/tree/vertex_add_subtree_sum-HLD.test.cpp\"\nusing\
    \ namespace std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<ll>\
    \ A(N); scan >> A;\n    Graph<int> G(N);\n    rep (i, 1, N) {\n        int p;\
  ...
  verifiedWith: []
documentation_of: test/yosupo/tree/vertex_add_subtree_sum-HLD.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/tree/vertex_add_subtree_sum-HLD.test.cpp
- /verify/test/yosupo/tree/vertex_add_subtree_sum-HLD.test.cpp.html
