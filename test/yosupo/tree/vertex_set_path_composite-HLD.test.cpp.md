...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree/vertex_set_path_composite-HLD.test.cpp\"\
    ...
    \        : root(root), G(G) {\n        init();\n    }\n    int get_size(int k)\
    \ const { return ssz[k]; }\n    std::pair<int, int> get_idx(int k) const { return\
    ...
    \        func(vin[l], vin[l]);\n        for (const auto& p : down_path(l, v))\
    \ func(p.first, p.second);\n    }\n    template<class F> void each_edge(int u,\
    ...
    \       f(vin[u], vout[u]);\n    }\n    template<class F> void each_edge_subtree(int\
    \ u, const F& f) const {\n        f(vin[u] + 1, vout[u]);\n    }\n};\n\n/**\n\
    \ * @brief HeavyLightDecomposition(HL\u5206\u89E3)\n * @docs docs/graph/tree/HeavyLightDecomposition.md\n\
    \ */\n#line 8 \"test/yosupo/tree/vertex_set_path_composite-HLD.test.cpp\"\nusing\
  ...
  verifiedWith: []
documentation_of: test/yosupo/tree/vertex_set_path_composite-HLD.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/tree/vertex_set_path_composite-HLD.test.cpp
- /verify/test/yosupo/tree/vertex_set_path_composite-HLD.test.cpp.html
