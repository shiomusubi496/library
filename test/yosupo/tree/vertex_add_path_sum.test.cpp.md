...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree/vertex_add_path_sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_path_sum\"\n#line 2 \"\
    ...
    \  }\n        else {\n            int u, v; scan >> u >> v;\n            ll ans\
    \ = 0;\n            ET.each_vertex(u, v, [&](int l, int r) { ans += BIT.sum(l,\
    \ r); });\n            print << ans << endl;\n        }\n    }\n}\n"
...
layout: document
redirect_from:
- /verify/test/yosupo/tree/vertex_add_path_sum.test.cpp
- /verify/test/yosupo/tree/vertex_add_path_sum.test.cpp.html
