...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree/tree_diameter.test.cpp\"\n#define PROBLEM\
    ...
    \ == dist[v] + e.cost) {\n                res[e.to] = e;\n                que.push(e.to);\n\
    \            }\n        }\n    }\n    return res;\n}\n\ntemplate<class T>\nEdges<T>\
    \ RestorePath(const Graph<T>& G, const std::vector<T>& dist, int s,\n        \
    \             int t) {\n    const Graph<T> RG = ReverseGraph(G);\n    std::vector<bool>\
    \ seen(G.size(), false);\n    seen[t] = true;\n    Edges<T> res;\n    while (s\
    \ != t) {\n        bool flg = false;\n        each_const (e : RG[t]) {\n     \
    \       if (!seen[e.to] && dist[e.to] + e.cost == dist[t]) {\n               \
    \ seen[e.to] = true;\n                res.emplace_back(e.to, e.from, std::move(e.cost),\
    \ e.idx);\n                t = e.to;\n                flg = true;\n          \
    \      break;\n            }\n        }\n        assert(flg);\n    }\n    std::reverse(all(res));\n\
    \    return res;\n}\n\n/**\n * @brief Restore(\u7D4C\u8DEF\u5FA9\u5143)\n * @docs\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/tree_diameter\"\n#include\
    ...
    \    int N; scan >> N;\n    Graph<ll> G(N);\n    rep (N - 1) {\n        int a,\
    \ b; ll c; scan >> a >> b >> c;\n        G.add_edge(a, b, c);\n    }\n    TreeDiameter<ll>\
    \ TD(G);\n    auto v = TD.get_path();\n    print << TD.diameter() << ' ' << v.size()\
    \ + 1 << endl;\n    print << v[0].from;\n    each_const (e : v) print << ' ' <<\
    \ e.to;\n    print << endl;\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
