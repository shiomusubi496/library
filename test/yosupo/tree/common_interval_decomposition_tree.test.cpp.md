...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree/common_interval_decomposition_tree.test.cpp\"\
    ...
    \ size() const {\n        assert(sorted);\n        return dat.size();\n    }\n\
    };\n#line 2 \"graph/tree/PermutationTree.hpp\"\n\n#line 2 \"other/monoid.hpp\"\
    ...
    \ */\n#line 4 \"test/yosupo/tree/common_interval_decomposition_tree.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int N; scan >> N;\n    vector<int> P(N);\
