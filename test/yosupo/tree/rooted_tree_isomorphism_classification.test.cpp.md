...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree/rooted_tree_isomorphism_classification.test.cpp\"\
    ...
    \ */\n#line 2 \"graph/tree/TreeHash.hpp\"\n\n#line 2 \"random/Random.hpp\"\n\n\
    ...
    \   }\n        return {dp, res};\n    }\n};\n\n/**\n * @brief TreeHash\n * @docs\
    \ docs/graph/tree/TreeHash.md\n */\n#line 5 \"test/yosupo/tree/rooted_tree_isomorphism_classification.test.cpp\"\
    \nusing namespace std;\nusing mint = modint61;\nint main() {\n    int N; scan\
    \ >> N;\n    Graph<int> G(N);\n    rep (i, 1, N) {\n        int p; scan >> p;\n\
...
layout: document
redirect_from:
- /verify/test/yosupo/tree/rooted_tree_isomorphism_classification.test.cpp
- /verify/test/yosupo/tree/rooted_tree_isomorphism_classification.test.cpp.html
