...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree/vertex_add_subtree_sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_subtree_sum\"\n#line 2\
    ...
    \u30FC)\n * @docs docs/graph/tree/EulerTour.md\n */\n#line 6 \"test/yosupo/tree/vertex_add_subtree_sum.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<ll>\
    \ A(N); scan >> A;\n    Graph<int> G(N);\n    rep (i, 1, N) {\n        int p;\
    \ scan >> p;\n        G.add_edge(i, p);\n    }\n    EulerTour<int> ET(G);\n  \
...
layout: document
redirect_from:
- /verify/test/yosupo/tree/vertex_add_subtree_sum.test.cpp
- /verify/test/yosupo/tree/vertex_add_subtree_sum.test.cpp.html
