...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/geometry/sort_points_by_argument.test.cpp\"\n\
    ...
    \ size() const {\n        assert(sorted);\n        return dat.size();\n    }\n\
    };\n#line 3 \"test/yosupo/geometry/sort_points_by_argument.test.cpp\"\n#define\
    ...
    \ return CCW::ONLINE_FRONT;\n    return CCW::ON_SEGMENT;\n}\n#line 5 \"test/yosupo/geometry/sort_points_by_argument.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int n; scan >> n;\n    vector<Point>\
    \ ps(n); scan >> ps;\n    sort(all(ps), [&](const Point& a, const Point& b) {\
    \ return comp_arg(a, b); });\n    for (const auto& p : ps) printer << p << endl;\n\
    }\n"
