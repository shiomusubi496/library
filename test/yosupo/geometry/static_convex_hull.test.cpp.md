...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/geometry/static_convex_hull.test.cpp\"\n#define\
    ...
    \ size() const {\n        assert(sorted);\n        return dat.size();\n    }\n\
    };\n#line 3 \"test/yosupo/geometry/static_convex_hull.test.cpp\"\n#define GEOMETRY_REAL_TYPE\
    ...
    \ b), Line(p0, p1)));\n        }\n    }\n    return res;\n}\n#line 5 \"test/yosupo/geometry/static_convex_hull.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int T; scan >> T;\n    rep (T) {\n \
  ...
  verifiedWith: []
documentation_of: test/yosupo/geometry/static_convex_hull.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/geometry/static_convex_hull.test.cpp
- /verify/test/yosupo/geometry/static_convex_hull.test.cpp.html
