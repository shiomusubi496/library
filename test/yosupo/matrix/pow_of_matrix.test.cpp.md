...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/matrix/pow_of_matrix.test.cpp\"\n#define PROBLEM\
    ...
    \ 5 \"test/yosupo/matrix/pow_of_matrix.test.cpp\"\nusing namespace std;\nusing\
  ...
  verifiedWith: []
documentation_of: test/yosupo/matrix/pow_of_matrix.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/matrix/pow_of_matrix.test.cpp
- /verify/test/yosupo/matrix/pow_of_matrix.test.cpp.html
