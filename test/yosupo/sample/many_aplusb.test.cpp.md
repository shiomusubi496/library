...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/sample/many_aplusb.test.cpp\"\n#define PROBLEM\
    ...
    \ data() && { return std::move(dat); }\n};\n#line 3 \"test/yosupo/sample/many_aplusb.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int T;\n    scan >> T;\n    rep (T)\
    \ {\n        ll a, b;\n        scan >> a >> b;\n        print << a + b << '\\\
    n';\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yosupo/sample/many_aplusb.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/sample/many_aplusb.test.cpp
- /verify/test/yosupo/sample/many_aplusb.test.cpp.html
