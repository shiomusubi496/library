...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/sample/aplusb.test.cpp\"\n#define PROBLEM \"\
    ...
    \ data() && { return std::move(dat); }\n};\n#line 3 \"test/yosupo/sample/aplusb.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int a, b;\n    scan >> a >> b;\n   \
    \ print << a + b << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yosupo/sample/aplusb.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/sample/aplusb.test.cpp
- /verify/test/yosupo/sample/aplusb.test.cpp.html
