...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/staticrmq-LinearRMQ.test.cpp\"\n#define PROBLEM\
    ...
    \u6BCE$\\Theta(1)$\u306ERMQ)\n * @docs docs/LinearRMQ.md\n */\n#line 4 \"test/yosupo/staticrmq-LinearRMQ.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int N, Q; cin >> N >> Q;\n    vector<int>\
  ...
  verifiedWith: []
documentation_of: test/yosupo/staticrmq-LinearRMQ.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/staticrmq-LinearRMQ.test.cpp
- /verify/test/yosupo/staticrmq-LinearRMQ.test.cpp.html
