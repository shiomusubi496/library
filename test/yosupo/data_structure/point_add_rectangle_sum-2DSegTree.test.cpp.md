...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/point_add_rectangle_sum-2DSegTree.test.cpp\"\
    ...
    \ a); }\n};\n\n} // namespace Monoid\n#line 2 \"data-struct/2D/SegmentTree2D.hpp\"\
    ...
    \ seg;\n    Struct2D str;\n\npublic:\n    SegmentTree2D(const std::vector<ll>&\
    ...
    \ Upd> void update(ll x, ll y, Upd&& upd) {\n        T cur = M::id();\n      \
    \  str.update(\n            x, y,\n            [&](int k, int i) {\n         \
    \       seg[k].update(i, upd);\n                cur = seg[k].get(i);\n       \
    ...
    \ y, [&](int k, int i) { seg[k].apply(i, v); });\n    }\n    T prod(ll l, ll r,\
    \ ll u, ll d) const {\n        T lsm = M::id(), rsm = M::id();\n        str.prod(l,\
    \ r, u, d, [&](int k, int a, int b, bool f) {\n            if (f) lsm = M::op(lsm,\
    ...
    \    T sm = M::id();\n        return str.min_left(r, u, d, [&] { return f(sm);\
    \ }, [&](int k, int a, int b, bool f) {\n            if (f) sm = M::op(sm, seg[k].prod(a,\
    ...
    \    if (a == 0) {\n            scan >> b >> c >> d;\n            A.push_back(b);\n\
    \            B.push_back(c);\n            C.push_back(0);\n        }\n       \
    \ else scan >> b >> c >> d >> e;\n    }\n    SegmentTree2D<Monoid::Sum<ll>> seg(A,\
...
layout: document
redirect_from:
- /verify/test/yosupo/data_structure/point_add_rectangle_sum-2DSegTree.test.cpp
- /verify/test/yosupo/data_structure/point_add_rectangle_sum-2DSegTree.test.cpp.html
