...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/rectangle_sum-WM.test.cpp\"\n\
    ...
    #line 5 \"test/yosupo/data_structure/rectangle_sum-WM.test.cpp\"\nusing namespace\
    \ std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<ll> A(N), B(N),\
  ...
  verifiedWith: []
documentation_of: test/yosupo/data_structure/rectangle_sum-WM.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/data_structure/rectangle_sum-WM.test.cpp
- /verify/test/yosupo/data_structure/rectangle_sum-WM.test.cpp.html
