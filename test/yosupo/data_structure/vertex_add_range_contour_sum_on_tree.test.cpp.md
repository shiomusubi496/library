...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    ...
    };\n#line 6 \"test/yosupo/data_structure/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<ll>\
    \ A(N); scan >> A;\n    Graph<int> G(N);\n    rep (N - 1) {\n        int a, b;\
  ...
  verifiedWith: []
documentation_of: test/yosupo/data_structure/vertex_add_range_contour_sum_on_tree.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/data_structure/vertex_add_range_contour_sum_on_tree.test.cpp
- /verify/test/yosupo/data_structure/vertex_add_range_contour_sum_on_tree.test.cpp.html
