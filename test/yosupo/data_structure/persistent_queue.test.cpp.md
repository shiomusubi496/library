...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/persistent_queue.test.cpp\"\n\
    ...
    \ */\n#line 4 \"test/yosupo/data_structure/persistent_queue.test.cpp\"\nusing\
    \ namespace std;\nint main() {\n    int q; scan >> q;\n    PersistentQueue<int>\
    \ que;\n    rep (q) {\n        int a; scan >> a;\n        if (a == 0) {\n    \
    \        int t, x; scan >> t >> x;\n            que.push(t, x);\n        }\n \
    \       else {\n            int t; scan >> t;\n            prints(que.front(t));\n\
