...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/staticrmq-SparseTable.test.cpp\"\
    ...
    \ */\n#line 4 \"test/yosupo/data_structure/staticrmq-SparseTable.test.cpp\"\n\
    using namespace std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<int>\
  ...
  verifiedWith: []
documentation_of: test/yosupo/data_structure/staticrmq-SparseTable.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/data_structure/staticrmq-SparseTable.test.cpp
- /verify/test/yosupo/data_structure/staticrmq-SparseTable.test.cpp.html
