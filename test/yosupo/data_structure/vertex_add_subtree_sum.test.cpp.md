...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/vertex_add_subtree_sum.test.cpp\"\
    ...
    \u30FC)\n * @docs docs/graph/tree/EulerTour.md\n */\n#line 6 \"test/yosupo/data_structure/vertex_add_subtree_sum.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<ll>\
    \ A(N); scan >> A;\n    Graph<int> G(N);\n    rep (i, 1, N) {\n        int p;\
    \ scan >> p;\n        G.add_edge(i, p);\n    }\n    EulerTour<int> ET(G);\n  \
