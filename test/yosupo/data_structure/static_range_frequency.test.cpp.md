...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/static_range_frequency.test.cpp\"\
    ...
    \ data() && { return std::move(dat); }\n};\n#line 2 \"data-struct/segment/StaticRangeFrequency.hpp\"\
    \n\n#line 4 \"data-struct/segment/StaticRangeFrequency.hpp\"\n\ntemplate<class\
    \ T, class Map = std::map<T, std::vector<int>>>\nclass StaticRangeFrequency {\n\
    ...
    \ */\n#line 4 \"test/yosupo/data_structure/static_range_frequency.test.cpp\"\n\
    using namespace std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<int>\
    \ A(N); scan >> A;\n    StaticRangeFrequency<int> srf(A);\n    rep (Q) {\n   \
    \     int l, r, x; scan >> l >> r >> x;\n        print << srf.count(l, r, x) <<\
    \ endl;\n    }\n}\n"
...
layout: document
redirect_from:
- /verify/test/yosupo/data_structure/static_range_frequency.test.cpp
- /verify/test/yosupo/data_structure/static_range_frequency.test.cpp.html
