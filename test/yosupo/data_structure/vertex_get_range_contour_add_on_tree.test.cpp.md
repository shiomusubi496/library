...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/vertex_get_range_contour_add_on_tree.test.cpp\"\
    ...
    \ l, r, [&](int p, int r) { bit[p].add(0, r, x); }, [&](int p, int r) { bit[p].add(0,\
    \ r, -x); });\n        }\n        else {\n            int p; scan >> p;\n    \
...
layout: document
redirect_from:
- /verify/test/yosupo/data_structure/vertex_get_range_contour_add_on_tree.test.cpp
- /verify/test/yosupo/data_structure/vertex_get_range_contour_add_on_tree.test.cpp.html
