...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_structure/range_reverse_range_sum.test.cpp\"\
    ...
    \ <= size());\n        if (l + 1 >= r) return;\n        node_ptr ptr = get_range(l,\
    \ r);\n        all_reverse(ptr);\n        splay(ptr);\n    }\n};\n#line 4 \"test/yosupo/data_structure/range_reverse_range_sum.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int N, Q; scan >> N >> Q;\n    vector<ll>\
...
layout: document
redirect_from:
- /verify/test/yosupo/data_structure/range_reverse_range_sum.test.cpp
- /verify/test/yosupo/data_structure/range_reverse_range_sum.test.cpp.html
