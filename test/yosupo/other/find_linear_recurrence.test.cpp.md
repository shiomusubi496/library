...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/other/find_linear_recurrence.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/find_linear_recurrence\"\n#line 2\
    ...
    \        if (2 * L <= i) {\n            L = i + 1 - L;\n            B = std::move(Q);\n\
    \            p = i;\n            b = d;\n        }\n        Q = std::move(R);\n\
    \    }\n    return Q.prefix(L + 1);\n}\n#line 5 \"test/yosupo/other/find_linear_recurrence.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yosupo/other/find_linear_recurrence.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/other/find_linear_recurrence.test.cpp
- /verify/test/yosupo/other/find_linear_recurrence.test.cpp.html
