...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/other/longest_increasing_subsequence.test.cpp\"\
    ...
    \ */\n#line 4 \"test/yosupo/other/longest_increasing_subsequence.test.cpp\"\n\
    using namespace std;\nint main() {\n    int n; scan >> n;\n    vector<int> a(n);\
  ...
  verifiedWith: []
documentation_of: test/yosupo/other/longest_increasing_subsequence.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/other/longest_increasing_subsequence.test.cpp
- /verify/test/yosupo/other/longest_increasing_subsequence.test.cpp.html
