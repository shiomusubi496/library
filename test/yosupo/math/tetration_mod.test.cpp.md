...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/math/tetration_mod.test.cpp\"\n#define PROBLEM\
    ...
    \ */\n#line 4 \"test/yosupo/math/tetration_mod.test.cpp\"\nusing namespace std;\n\
    int main() {\n    int t; scan >> t;\n    rep (t) {\n        ll a, b, m; scan >>\
  ...
  verifiedWith: []
documentation_of: test/yosupo/math/tetration_mod.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/math/tetration_mod.test.cpp
- /verify/test/yosupo/math/tetration_mod.test.cpp.html
