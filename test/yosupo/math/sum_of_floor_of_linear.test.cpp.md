...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/math/sum_of_floor_of_linear.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/sum_of_floor_of_linear\"\n#line 2\
    ...
    #line 4 \"math/FloorSum.hpp\"\n\null floor_sum_unsigned(ull n, ull m, ull a, ull\
    \ b) {\n    ull ans = 0;\n    while (true) {\n        if (a >= m) {\n        \
    \    ans += n * (n - 1) / 2 * (a / m);\n            a %= m;\n        }\n     \
    \   if (b >= m) {\n            ans += n * (b / m);\n            b %= m;\n    \
    \    }\n        ull y = a * n + b;\n        if (y < m) break;\n        n = y /\
    ...
    \ */\n#line 4 \"test/yosupo/math/sum_of_floor_of_linear.test.cpp\"\nint main()\
    \ {\n    int t; scan >> t;\n    while (t--) {\n        ll n, m, a, b; scan >>\
  ...
  verifiedWith: []
documentation_of: test/yosupo/math/sum_of_floor_of_linear.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/math/sum_of_floor_of_linear.test.cpp
- /verify/test/yosupo/math/sum_of_floor_of_linear.test.cpp.html
