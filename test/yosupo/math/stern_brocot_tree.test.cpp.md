...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/math/stern_brocot_tree.test.cpp\"\n#define PROBLEM\
    ...
    \        }\n        return {-1, -1};\n    }\n};\n\n/**\n * @brief Stern-Brocot\
    \ Tree\n * @docs docs/math/SternBrocotTree.md\n */\n#line 5 \"test/yosupo/math/stern_brocot_tree.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yosupo/math/stern_brocot_tree.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/math/stern_brocot_tree.test.cpp
- /verify/test/yosupo/math/stern_brocot_tree.test.cpp.html
