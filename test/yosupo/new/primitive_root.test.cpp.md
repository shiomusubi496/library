...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/primitive_root.test.cpp\"\n#define PROBLEM\
    ...
    \u59CB\u6839)\n * @docs docs/math/PrimitiveRoot.md\n */\n#line 4 \"test/yosupo/new/primitive_root.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int q; scan >> q;\n    rep (q) {\n \
...
layout: document
redirect_from:
- /verify/test/yosupo/new/primitive_root.test.cpp
- /verify/test/yosupo/new/primitive_root.test.cpp.html
