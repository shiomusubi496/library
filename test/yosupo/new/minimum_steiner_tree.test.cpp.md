...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/minimum_steiner_tree.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/minimum_steiner_tree\"\n#line 2 \"\
    ...
    \ res};\n}\n#line 5 \"test/yosupo/new/minimum_steiner_tree.test.cpp\"\nusing namespace\
    \ std;\nint main() {\n    int N, M; scan >> N >> M;\n    Graph<ll> G(N);\n   \
    \ rep (M) {\n        int a, b; scan >> a >> b;\n        ll c; scan >> c;\n   \
    \     G.add_edge(a, b, c);\n    }\n    int K; scan >> K;\n    vector<int> X(K);\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/minimum_steiner_tree\"\n\
    ...
    \ auto res = minimum_steiner_tree(G, X);\n    vector<int> idx;\n    rep (i, res.second.size())\
    \ idx.push_back(res.second[i].idx);\n    prints(res.first, res.second.size());\n\
    \    prints(idx);\n}\n"
  dependsOn:
  - other/template.hpp
  - template/macros.hpp
  ...
  verifiedWith: []
documentation_of: test/yosupo/new/minimum_steiner_tree.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/new/minimum_steiner_tree.test.cpp
- /verify/test/yosupo/new/minimum_steiner_tree.test.cpp.html
