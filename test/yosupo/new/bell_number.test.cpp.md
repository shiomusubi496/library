...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/bell_number.test.cpp\"\n#define PROBLEM\
    ...
    #line 5 \"test/yosupo/new/bell_number.test.cpp\"\nusing namespace std;\nusing\
  ...
  verifiedWith: []
documentation_of: test/yosupo/new/bell_number.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/new/bell_number.test.cpp
- /verify/test/yosupo/new/bell_number.test.cpp.html
