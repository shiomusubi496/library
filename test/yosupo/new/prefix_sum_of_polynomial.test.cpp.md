...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/prefix_sum_of_polynomial.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/prefix_sum_of_polynomial\"\n#line\
    ...
    \n/**\n * @brief ModInt\n * @docs docs/math/ModInt.md\n */\n#line 2 \"math/poly/PolynomialPrefixSum.hpp\"\
    ...
    #line 7 \"math/poly/PolynomialPrefixSum.hpp\"\n\ntemplate<class T, class Comb\
    \ = Combinatorics<T>>\nFormalPowerSeries<T> polynomial_prefix_sum(FormalPowerSeries<T>\
    \ f) {\n    int n = f.size();\n    if (n == 0) return {0};\n    Comb::init(n);\n\
    \    rep (i, n) f[i] *= Comb::fact(i);\n    FormalPowerSeries<T> g = bernoulli_number<T,\
    \ Comb>(n - 1);\n    rep (i, n) g[i] *= Comb::finv(i);\n    std::reverse(all(g));\n\
    \    f *= g;\n    FormalPowerSeries<T> res(n + 1);\n    reps (i, n) res[i] = f[i\
    \ + n - 2] * Comb::finv(i);\n    return res;\n}\n#line 5 \"test/yosupo/new/prefix_sum_of_polynomial.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2026-09-19 00:23:44+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yosupo/new/prefix_sum_of_polynomial.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/new/prefix_sum_of_polynomial.test.cpp
- /verify/test/yosupo/new/prefix_sum_of_polynomial.test.cpp.html
