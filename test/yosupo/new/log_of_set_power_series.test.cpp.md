...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/log_of_set_power_series.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/log_of_set_power_series\"\n#line 2\
    ...
    \ 1 << i) a[j + (1 << i)] = d[j];\n    }\n    return a;\n}\n#line 5 \"test/yosupo/new/log_of_set_power_series.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yosupo/new/log_of_set_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/new/log_of_set_power_series.test.cpp
- /verify/test/yosupo/new/log_of_set_power_series.test.cpp.html
