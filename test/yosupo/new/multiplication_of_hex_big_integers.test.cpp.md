...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/multiplication_of_hex_big_integers.test.cpp\"\
    ...
    }\n#line 4 \"test/yosupo/new/multiplication_of_hex_big_integers.test.cpp\"\nusing\
    \ namespace std;\nint main() {\n    int T; scan >> T;\n    rep (T) {\n       \
  ...
  verifiedWith: []
documentation_of: test/yosupo/new/multiplication_of_hex_big_integers.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/new/multiplication_of_hex_big_integers.test.cpp
- /verify/test/yosupo/new/multiplication_of_hex_big_integers.test.cpp.html
