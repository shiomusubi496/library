...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/aho_corasick.test.cpp\"\n#define PROBLEM\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aho_corasick\"\n#include\
    ...
    \nusing namespace std;\nint main() {\n    int N; scan >> N;\n    vector<string>\
    \ S(N); scan >> S;\n    AhoCorasick<'a', 'z'> ac;\n    rep (i, N) ac.insert(S[i]);\n\
    \    ac.build();\n    prints(ac.size());\n    rep (i, 1, ac.size()) prints(ac.get_par(i),\
    \ ac.get_fail(i));\n    vector<int> res(N);\n    rep (i, N) res[i] = ac.get_node(S[i]);\n\
    \    prints(res);\n}\n"
  dependsOn:
  - other/template.hpp
  ...
  requiredBy: []
  timestamp: '2026-09-16 16:09:24+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yosupo/new/aho_corasick.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/new/aho_corasick.test.cpp
- /verify/test/yosupo/new/aho_corasick.test.cpp.html
