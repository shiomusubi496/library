...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/new/primality_test.test.cpp\"\n#define PROBLEM\
    ...
    \u6570\u5224\u5B9A)\n * @docs docs/math/MillerRabin.md\n */\n#line 4 \"test/yosupo/new/primality_test.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int T; scan >> T;\n    rep (T) {\n \
  ...
  verifiedWith: []
documentation_of: test/yosupo/new/primality_test.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/new/primality_test.test.cpp
- /verify/test/yosupo/new/primality_test.test.cpp.html
