...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/convolution/convolution_mod_2_64.test.cpp\"\n\
    ...
    \ - 1) c[i + k * 2] += c2[i];\n    c.resize(n + m - 1);\n    return c;\n}\n#line\
    \ 4 \"test/yosupo/convolution/convolution_mod_2_64.test.cpp\"\nusing namespace\
    \ std;\nint main() {\n    int n, m; scan >> n >> m;\n    vector<ull> a(n), b(m);\
...
layout: document
redirect_from:
- /verify/test/yosupo/convolution/convolution_mod_2_64.test.cpp
- /verify/test/yosupo/convolution/convolution_mod_2_64.test.cpp.html
