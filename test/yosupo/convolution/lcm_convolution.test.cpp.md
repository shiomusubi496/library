...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/convolution/lcm_convolution.test.cpp\"\n#define\
    ...
    \ */\n#line 7 \"test/yosupo/convolution/lcm_convolution.test.cpp\"\nusing namespace\
    \ std;\nusing mint = modint998244353;\nint main() {\n    int N; scan >> N;\n \
    \   vector<mint> A(N + 1), B(N + 1);\n    reps (i, N) scan >> A[i];\n    reps\
    \ (i, N) scan >> B[i];\n    auto v = lcm_convolution<Monoid::Sum<mint>, Monoid::Product<mint>>(A,\
    \ B);\n    reps (i, N) print << v[i] << \" \\n\"[i == N];\n}\n"
...
layout: document
redirect_from:
- /verify/test/yosupo/convolution/lcm_convolution.test.cpp
- /verify/test/yosupo/convolution/lcm_convolution.test.cpp.html
