...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/convolution/mul_modp_convolution.test.cpp\"\n\
    ...
    \n/**\n * @brief ModInt\n * @docs docs/math/ModInt.md\n */\n#line 2 \"math/convolution/MultiplicationConvolution.hpp\"\
    ...
    \        res[t] += e[i] + e[i + n - 1];\n        t = (t * g) % n;\n    }\n   \
    \ return res;\n}\n#line 5 \"test/yosupo/convolution/mul_modp_convolution.test.cpp\"\
    \nusing namespace std;\nusing mint = modint998244353;\nint main() {\n    int P;\
    \ scan >> P;\n    vector<mint> a(P), b(P); scan >> a >> b;\n    prints(multiplication_convolution(a,\
    \ b));\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yosupo/convolution/mul_modp_convolution.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/convolution/mul_modp_convolution.test.cpp
- /verify/test/yosupo/convolution/mul_modp_convolution.test.cpp.html
