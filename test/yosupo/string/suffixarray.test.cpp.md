...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/string/suffixarray.test.cpp\"\n#define PROBLEM\
    ...
    \ */\n#line 4 \"test/yosupo/string/suffixarray.test.cpp\"\nusing namespace std;\n\
  ...
  verifiedWith: []
documentation_of: test/yosupo/string/suffixarray.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/string/suffixarray.test.cpp
- /verify/test/yosupo/string/suffixarray.test.cpp.html
