...
data:
  ...
  bundledCode: "#line 1 \"test/yuki/705-Monge.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/705\"\
    ...
    \ - m]));\n        self(m, r);\n    })(0, n);\n    return dp;\n}\n\n/**\n * @brief\
    \ Online Offline DP\n * @docs docs/dp/OnlineOfflineDP.md\n */\n#line 4 \"test/yuki/705-Monge.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int n; scan >> n;\n    vector<ll> a(n);\
    \ scan >> a;\n    vector<ll> x(n), y(n); scan >> x >> y;\n    auto cube = [&](ll\
    \ x) { return x * x * x; };\n    prints(online_offline_dp(n + 1, [&](int l, int\
...
layout: document
redirect_from:
- /verify/test/yuki/705-Monge.test.cpp
- /verify/test/yuki/705-Monge.test.cpp.html
