...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DSL/DSL_1_B-WeightedUF.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"test/aoj/DSL/DSL_1_B-WeightedUF.test.cpp\"\nusing namespace std;\nint main()\
    \ {\n    int n, q; scan >> n >> q;\n    WeightedUnionFind<ll> WUF(n);\n    rep\
    \ (q) {\n        int t; scan >> t;\n        if (t == 0) {\n            int x,\
    \ y, z; scan >> x >> y >> z;\n            WUF.merge(x, y, z);\n        }\n   \
    \     else {\n            int x, y; scan >> x >> y;\n            if (WUF.same(x,\
    \ y)) printer << WUF.diff(x, y) << endl;\n            else printer << \"?\" <<\
    \ endl;\n        }\n    }\n}\n"
...
layout: document
redirect_from:
- /verify/test/aoj/DSL/DSL_1_B-WeightedUF.test.cpp
- /verify/test/aoj/DSL/DSL_1_B-WeightedUF.test.cpp.html
