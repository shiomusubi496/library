...
data:
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_3_C\"\n#include\
    ...
    \nusing namespace std;\nint main() {\n    int N; scan >> N;\n    vector<int> A(N);\
    \ scan >> A;\n    ll ans = 0;\n    max_rectangle_of_histogram(A, [&](int l, int\
...
layout: document
redirect_from:
- /verify/test/aoj/DPL/DPL_3_C.test.cpp
- /verify/test/aoj/DPL/DPL_3_C.test.cpp.html
