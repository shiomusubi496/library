...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/NTL/NTL_1_E-ExtGCD.test.cpp\"\n#define PROBLEM\
    ...
    \ main() {\n    int a, b; scan >> a >> b;\n    PLL p = extGCD(a, b);\n    if (p.first\
    \ - p.second < (p.second + a) - (p.first - b)) printer << p << endl;\n    else\
    \ printer << p.first - b << ' ' << p.second + a << endl;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/NTL_1_E\"\n#include\
    \ \"../../../other/template.hpp\"\nusing namespace std;\nint main() {\n    int\
    \ a, b; scan >> a >> b;\n    PLL p = extGCD(a, b);\n    if (p.first - p.second\
    \ < (p.second + a) - (p.first - b)) printer << p << endl;\n    else printer <<\
...
layout: document
redirect_from:
- /verify/test/aoj/NTL/NTL_1_E-ExtGCD.test.cpp
- /verify/test/aoj/NTL/NTL_1_E-ExtGCD.test.cpp.html
