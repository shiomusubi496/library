...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/CGL_2_D-distance.test.cpp\"\n#define PROBLEM\
    ...
    \ p - s.p1) < 0) return distance(p, s.p1);\n    if (dot(s.p1 - s.p2, p - s.p2)\
    \ < 0) return distance(p, s.p2);\n    return distance(p, Line(s));\n}\nReal distance(const\
...
layout: document
redirect_from:
- /verify/test/aoj/CGL/CGL_2_D-distance.test.cpp
- /verify/test/aoj/CGL/CGL_2_D-distance.test.cpp.html
