...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/GRL/GRL_4_A-Cycle.test.cpp\"\n#define PROBLEM \"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/GRL_4_A\"\n#include\
    ...
    \    int V, E; cin >> V >> E;\n    Graph<int> G(V);\n    rep (E) {\n        int\
    \ a, b; cin >> a >> b;\n        G.add_edge(a, b, true);\n    }\n    cout << GraphCycle<int>(G).has_cycle()\
    \ << endl;\n}\n"
  dependsOn:
  - other/template.hpp
  - graph/Graph.hpp
...
layout: document
redirect_from:
- /verify/test/aoj/GRL/GRL_4_A-Cycle.test.cpp
- /verify/test/aoj/GRL/GRL_4_A-Cycle.test.cpp.html
