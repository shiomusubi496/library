...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/GRL/GRL_5_A-Diameter.test.cpp\"\n#define PROBLEM\
    ...
    \ { return {s, t}; }\n    Edges<T> get_path() const { return RestorePath(G, dist,\
    \ s, t); }\n};\n\n/**\n * @brief TreeDiameter(\u6728\u306E\u76F4\u5F84)\n * @docs\
    \ docs/TreeDiameter.md\n */\n#line 5 \"test/aoj/GRL/GRL_5_A-Diameter.test.cpp\"\
    \nusing namespace std;\nint main() {\n    int N; cin >> N;\n    Graph<int> G(N);\n\
    \    rep (N - 1) {\n        int a, b, c;\n        cin >> a >> b >> c;\n      \
...
layout: document
redirect_from:
- /verify/test/aoj/GRL/GRL_5_A-Diameter.test.cpp
- /verify/test/aoj/GRL/GRL_5_A-Diameter.test.cpp.html
