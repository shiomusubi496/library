...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/3369
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/3369
  bundledCode: "#line 1 \"test/aoj/other/3369-CountSpanningTree.test.cpp\"\n#define\
    ...
    #line 5 \"test/aoj/other/3369-CountSpanningTree.test.cpp\"\nusing namespace std;\n\
    using mint = modint998244353;\nint main() {\n    int N, M; scan >> N >> M;\n \
    \   Graph<int> G(N);\n    rep (M) {\n        int a, b; scan >> a >> b;\n     \
    \   G.add_edge(--a, --b);\n    }\n    prints(count_spanning_tree<mint>(G) * (M\
    \ - N + 1));\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/3369\"\n#include\
  ...
  verifiedWith: []
documentation_of: test/aoj/other/3369-CountSpanningTree.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/other/3369-CountSpanningTree.test.cpp
- /verify/test/aoj/other/3369-CountSpanningTree.test.cpp.html
