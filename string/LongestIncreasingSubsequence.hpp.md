...
data:
  ...
  attributes:
    ...
    document_title: "LongestIncreasingSubsequence(LIS,\u6700\u9577\u5897\u52A0\u90E8\
      \u5206\u5217)"
    links: []
  bundledCode: "#line 2 \"string/LongestIncreasingSubsequence.hpp\"\n\n#line 2 \"\
    other/template.hpp\"\n\n#include <bits/stdc++.h>\n\n#ifndef __COUNTER__\n#define\
  ...
  code: "#pragma once\n\n#include \"../other/template.hpp\"\n\ntemplate<class Cont>\n\
    ...
    \ itr = strict ? std::lower_bound(all(dp), i, cmp)\n                         \
    \     : std::upper_bound(all(dp), i, cmp);\n            prv[i] = itr == dp.begin()\
    \ ? -1 : *(itr - 1);\n            *itr = i;\n        }\n        int len = 0, lst\
    \ = -1;\n        reps (i, n) {\n            if (dp[i] != -1) {\n             \
    \   len = i;\n                lst = dp[i];\n            }\n            else break;\n\
...
layout: document
redirect_from:
- /library/string/LongestIncreasingSubsequence.hpp
- /library/string/LongestIncreasingSubsequence.hpp.html
