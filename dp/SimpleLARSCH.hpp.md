...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"dp/SimpleLARSCH.hpp\"\n\n#line 2 \"other/template.hpp\"\n\
    ...
    \ function_traits<F>::result_type> simple_larsch(int n,\n                    \
    \                                                F&& f) {\n    using T = typename\
...
documentation_of: dp/SimpleLARSCH.hpp
layout: document
redirect_from:
- /library/dp/SimpleLARSCH.hpp
- /library/dp/SimpleLARSCH.hpp.html
