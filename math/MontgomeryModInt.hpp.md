...
モンゴメリ乗算を用いた modint。 mod を取るのを `%` や `/` を用いず、加減乗とシフト演算などで行うため、実行時に mod が決まる場合に高速。([Wikipedia](https://ja.wikipedia.org/wiki/%E3%83%A2%E3%83%B3%E3%82%B4%E3%83%A1%E3%83%AA%E4%B9%97%E7%AE%97))
