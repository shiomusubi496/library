...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/MontmortNumber.md
    document_title: "MontmortNumber(\u652A\u4E71\u9806\u5217)"
    links: []
  bundledCode: "#line 2 \"math/MontmortNumber.hpp\"\n\n#line 2 \"other/template.hpp\"\
...
documentation_of: math/MontmortNumber.hpp
layout: document
redirect_from:
- /library/math/MontmortNumber.hpp
- /library/math/MontmortNumber.hpp.html
title: "MontmortNumber(\u652A\u4E71\u9806\u5217)"
---
## 概要

攪乱順列、つまり $p_i \neq i$ なる順列 $p$ の個数を求める。単純な漸化式で求められる。

- `vector<T> montmort_number(int n)` : $0 \leq i \leq n$ の $i$ に対して攪乱順列の個数を返す。 $\Theta(n)$ 。
