...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/convolution/MultidimensionalConvolution.md
    document_title: MultidimensionalConvolution
    links: []
  bundledCode: "#line 2 \"math/convolution/MultidimensionalConvolution.hpp\"\n\n#line\
    ...
    \ {\nprivate:\n    static constexpr unsigned int lg = bitop::msb((T::get_mod()\
    \ - 1) & (1 - T::get_mod()));\n    T root[lg + 1];\n    T inv_root[lg + 1];\n\
    \    T rate[lg + 1];\n    T inv_rate[lg + 1];\n\npublic:\n    constexpr NthRoot()\
    \ : root{}, inv_root{}, rate{}, inv_rate{} {\n        root[lg] = T{primitive_root_for_convolution(T::get_mod())}.pow((T::get_mod()\
    ...
    )\n * @docs docs/math/convolution/Convolution.md\n */\n#line 5 \"math/convolution/MultidimensionalConvolution.hpp\"\
    \n\ntemplate<class T>\nstd::vector<T> multidimensional_convolution(const std::vector<T>&\
    \ a,\n                                            const std::vector<T>& b,\n \
...
documentation_of: math/convolution/MultidimensionalConvolution.hpp
layout: document
redirect_from:
- /library/math/convolution/MultidimensionalConvolution.hpp
- /library/math/convolution/MultidimensionalConvolution.hpp.html
