...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/SubsetSum.md
    document_title: SubsetSum
    links: []
  bundledCode: "#line 2 \"math/SubsetSum.hpp\"\n\n#line 2 \"other/template.hpp\"\n\
  ...
  code: "#pragma once\n\n#include \"../other/template.hpp\"\n#include \"../string/RunLength.hpp\"\
    ...
    template<class T, class Comb = Combinatorics<T>>\nstd::vector<T> subset_sum(std::vector<int>\
    \ a, int n) {\n    if (a.empty()) {\n        FormalPowerSeries<T> f(n + 1);\n\
    \        f[0] = 1;\n        return f;\n    }\n    std::sort(all(a));\n    assert(a[0]\
    \ > 0);\n    FormalPowerSeries<T> f(n + 1);\n    for (auto p : RunLength(a)) {\n\
    \        int x = p.first;\n        T y = p.second;\n        rep (i, 1, n / x +\
...
documentation_of: math/SubsetSum.hpp
layout: document
redirect_from:
- /library/math/SubsetSum.hpp
- /library/math/SubsetSum.hpp.html
title: SubsetSum
---
## 概要
