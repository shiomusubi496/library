...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/poly/SquareRoot.hpp\"\n\n#line 2 \"other/template.hpp\"\
    ...
    \ = i;\n            break;\n        }\n    }\n    if (d == -1) {\n        FormalPowerSeries<T>\
    \ res(deg);\n        return res;\n    }\n    if (d & 1) return {};\n    deg -=\
    \ (d >> 1);\n    if (deg <= 0) {\n        FormalPowerSeries<T> res(deg + (d >>\
    \ 1));\n        return res;\n    }\n    t >>= d;\n    T sq = sqrt_mod<T>(a.get());\n\
    \    if (sq == -1) return {};\n    FormalPowerSeries<T> f(1, sq), g(1, 1 / sq),\
    \ dft_f = f;\n    number_theoretic_transform(dft_f);\n    for (int m = 1; m <\
    \ deg; m <<= 1) {\n        dft_f.ntt_doubling(f);\n        f.resize(2 * m);\n\
...
documentation_of: math/poly/SquareRoot.hpp
layout: document
redirect_from:
- /library/math/poly/SquareRoot.hpp
- /library/math/poly/SquareRoot.hpp.html
