...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"math/poly/TaylorShift.hpp\"\n\n#line 2 \"other/template.hpp\"\
    ...
    \ Combinatorics<T>>\nFormalPowerSeries<T> taylor_shift(FormalPowerSeries<T> f,\
    \ T a) {\n    const int n = f.size();\n    Comb::init(n);\n    rep (i, n) f[i]\
...
layout: document
redirect_from:
- /library/math/poly/TaylorShift.hpp
- /library/math/poly/TaylorShift.hpp.html
title: TaylorShift
---
## 概要
