...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/matrix/AdjugateMatrix.hpp\"\n\n#line 2 \"other/template.hpp\"\
    ...
    \                 bool sol = true) {\n        assert(A_.height() == (int)b.size());\n\
    \        n = A_.height();\n        m = A_.width();\n        A = Matrix<bool>(n,\
    \ m + 1);\n        rep (i, n) {\n            rep (j, m) A.get(i, j) = A_.get(i,\
    \ j);\n            A.get(i, m) = b[i];\n        }\n        if (sol) solve();\n\
    \    }\n    bool solve() {\n        assert(!is_solved);\n        is_solved = true;\n\
    \        A.gauss();\n        int r = A.rank(true);\n        if (r != 0) {\n  \
    \          bool f = true;\n            rep (i, m) if (A.get(r - 1, i) != 0) f\
    \ = false;\n            if (f && A.get(r - 1, m) != 0) {\n                return\
  ...
  code: "#pragma once\n\n#include \"../../other/template.hpp\"\n#include \"Matrix.hpp\"\
    ...
    \    const int n = mat.height();\n    const int r = mat.rank();\n    if (r ==\
    \ n) return inverse(mat) * determinant(mat);\n    if (r < n - 1) return Matrix<T>(n,\
...
documentation_of: math/matrix/AdjugateMatrix.hpp
layout: document
redirect_from:
- /library/math/matrix/AdjugateMatrix.hpp
- /library/math/matrix/AdjugateMatrix.hpp.html
