...
data:
  ...
  code: "#pragma once\n\n#include \"template.hpp\"\n#include \"Point.hpp\"\n#include\
    ...
    \ a = c1.c.x, b = c1.c.y, r = c1.r;\n    const Real c = c2.c.x, d = c2.c.y, s\
    \ = c2.r;\n    const Real p = -2 * a + 2 * c, q = -2 * b + 2 * d;\n    const Real\
    \ r2 = a * a + b * b - c * c - d * d - r * r + s * s;\n    return Line(p, q, r2);\n\
    }\n\n#ifndef GEOMETRY_REAL_TYPE\nstd::vector<Point> intersections(const Circle&\
    \ c1, const Circle& c2) {\n    const Line l = radical_axis(c1, c2);\n    return\
    \ intersections(c1, l);\n}\n#endif\n\nLine tangent_at_point(const Circle& c, const\
